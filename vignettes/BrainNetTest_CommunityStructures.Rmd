...
Because the result is a `critical_links` object, `plot()` dispatches to that
function. The populations have to be passed in, since the object stores the
*modified* populations, from which the critical edges have been removed.
