...
test_that("generate_category_graphs is reproducible with seed", {
  g1 <- generate_category_graphs(n_graphs = 5, n_nodes = 10, n_communities = 2,
    base_intra_prob = 0.7, base_inter_prob = 0.2, seed = 42)
  g2 <- generate_category_graphs(n_graphs = 5, n_nodes = 10, n_communities = 2,
    base_intra_prob = 0.7, base_inter_prob = 0.2, seed = 42)
...
test_that("generate_category_graphs validates inputs", {
  ...
  expect_error(
    ...
    "between 0 and 1")
  expect_error(
    generate_category_graphs(n_graphs = 3, n_nodes = 10, n_communities = 3,
